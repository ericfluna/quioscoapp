  ...
  return (
    <div className="shadow p-5 mb-3 flex gap-10 items-center">
      ...
      <div className=" space-y-3">
        <button
          type="button"
          className="bg-sky-700 flex px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full gap-3"
        ...
        <button
          type="button"
          className="bg-red-700 flex px-5 py-2 text-white rounded-md font-bold uppercase shadow-md w-full gap-3"
